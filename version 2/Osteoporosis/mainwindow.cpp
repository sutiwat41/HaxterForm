...
bool MainWindow::printDocument()
{
    ...
    outputStrPaper = outputStrPaper + " <head> <style> table, tr, td {font-size: 22px; padding:10px; vertical-align: middle; border: 1px; border-style: solid; border-collapse: collapse;   cellspacing='0'; padding-bottom:15px }\
    ...
    outputStrPaper = outputStrPaper + "<p>ชื่อ-นามสกุล………………………………………………………………เลขประจำตัวโรงพยาบาล…………………………… \
                                       <p>อายุ…………………………ปี\t\t\t\t เพศ <span> \t </span> หญิง <span> \t  </span> ชาย \
                                       <p>น้ำหนัก……………………กิโลกรัม 		 ส่วนสูง……………………………เซนติเมตร</p>";
    for(int i = 0;i<openCSV.maxQuestion;i++){
...
//            outputStrPaper = outputStrPaper+ "ตอบ" + "\t"+ans.c_str() +"<br>";
            outputStrPaper = outputStrPaper + "<table style='padding:5px;'> <tr> \
                                              <td> <span>   "+xAns[0].c_str()+"   </span> ใช่ </td> \
                                              <td> <span>   "+xAns[1].c_str()+"   </span> ไม่แน่ใจ </td> \
                                              <td> <span>   "+xAns[2].c_str()+"   </span>  ไม่ </td> \
                                              </tr> </table> <br><br>";
    }
...
//    document.setDefaultStyleSheet(" body {font-size: 20px; font-family: Times New Roman,JasmineUPC}");
    document.setDefaultStyleSheet(" body {font-size: 20px; font-family:TH Sarabun New} h1 {font-size: 30 px;} p {font-size: 22px;}");
